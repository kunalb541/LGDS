...
that is tight in three structural regimes (rank-$1$ Jacobians,
...
this paper. Both are smooth, except that $\lambda_{\max}(PKP)$ is
non-smooth at eigenvalue crossings (\S\ref{sec:setup}).}
\label{tab:compare}
\begin{center}
\begin{tabular}{lll}
\toprule
