...
The asymmetry in the off-diagonal entries reflects the geometry of the
instance: $U^*_2$ is optimised for directions nearly orthogonal to $T_1$,
so its cross-regret is large; $U^*_1$ retains partial overlap with the
