...
Numerical illustrations confirm a no-global-privilege instance
($\Gamma=\GammaCondA>0$) and a structurally coherent construction,
both consistent with the theorem.
\end{abstract}

\keywords{linear Gaussian dynamical systems, dimensionality reduction,
Grassmannian optimization, Ky Fan theorem, principal subspaces}

\maketitle

\noindent\textit{MSC 2020:} 15A18; 93B07; 62H25\par\medskip
...
The result yields an exact risk formula, a no-global-privilege corollary,
and an exact algebraic criterion for the exceptional coherent case.
