...
are a necessary condition for an interior minimax, confirming the global
...
$U^*_2$'s row space makes a $\CondAAngleOne^\circ$ angle with $M_1$'s
dominant eigendirection, forfeiting most of its eigenvalue weight, while
the smaller $\CondAAngleTwo^\circ$ second angle means $U^*_1$ retains
substantial alignment with $M_2$'s second direction.
